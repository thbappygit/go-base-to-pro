...
# 🧠 Go `defer` – Complete Rules & Tricks (Bangla)

এই ডকুমেন্টটি Go ভাষার `defer` বুঝে মনে রাখার জন্য একটি **Bangla Cheat Sheet**।
Beginner থেকে Interview পর্যন্ত কাজে লাগবে।

---

## 🔹 1. `defer` কখন execute হয়?

* `defer` **সবসময় function শেষ হওয়ার ঠিক আগে execute হয়**
* Line-by-line execute হয় না

**ট্রিক মনে রাখুন:**
👉 *defer মানে — শেষে করবো*

---

## 🔹 2. `defer` কোন scope এর সাথে কাজ করে?

* `defer` **যেই function এর ভিতরে লেখা হয়**
* সেই function শেষ হলে execute হয়

❌ Loop শেষ মানেই `defer` চলবে — এটা ভুল
...
## 🔹 3. একাধিক `defer` হলে কী হয়?

* `defer` **LIFO (Last In First Out)** নিয়মে চলে
* Stack-এর মতো কাজ করে
...
**ট্রিক:**
👉 *শেষে ঢুকেছে, আগে বের হবে*

---

## 🔹 4. `defer` arguments কখন evaluate হয়?

* `defer` লেখার সময়ই arguments evaluate হয়
* execute হওয়ার সময় নয়
...
**ট্রিক:**
👉 *value আগে প্যাকেট হয়*

---

## 🔹 5. `defer` + Loop (⚠️ Danger Zone)

* Loop এর ভিতরে `defer` দিলে
* সব defer **function শেষ হলে একসাথে execute হয়**
...
**ট্রিক:**
👉 *loop শেষ ≠ defer execute*

---

## 🔹 6. `defer` + Loop + Closure (🔥 Biggest Trap)
...
* Loop variable reuse হয়
* defer পরে execute হয়
...
## 🔹 7. Loop + defer সঠিকভাবে লেখার নিয়ম
...
**ট্রিক:**
👉 *value parameter এ পাঠাও*

---

## 🔹 8. `defer` resource cleanup এ কেন ব্যবহার হয়?
...
**ট্রিক:**
👉 *খুললে সঙ্গে সঙ্গে defer করো*

---

## 🔹 9. Loop এর ভিতরে resource + defer (⚠️ Warning)

* Loop এ resource open করে defer করলে
...
## 🔹 10. Named return variable কী?

```go
func test() (x int)
```

* `x` আগে থেকেই declare থাকে
* Default value = 0
* `defer` এই `x` পরিবর্তন করতে পারে

**ট্রিক:**
👉 *named return = mutable*

---

## 🔹 11. Named return + defer

* `defer` **return value পরিবর্তন করতে পারে**
...
**ট্রিক:**
👉 *named return = defer magic*

---

## 🔹 12. Normal (unnamed) return
...
* `return x` এ value আগে copy হয়
* `defer` return value পরিবর্তন করতে পারে না
...
## 🔹 13. `return` + `defer` execution order

1. Return value evaluate হয়
2. Defer function execute হয়
3. Function exit হয়
...
## 🔹 14. কখন `defer` ব্যবহার করা উচিত নয়?
...
* **“defer runs at function exit, not loop exit”**
* **“named return value can be modified by defer”**


// Go তে defer সম্পর্কিত নিয়ম
/*
Named return values
---------------------------
1. প্রথমে সব কোড execute হয়
2. defer function গুলো stack বা "magic box"-এ store হয়
3. return হওয়ার ঠিক আগে defer function গুলো execute হয়
4. return value হিসেবে named variable-এর শেষ মান return হয়
...
1. প্রথমে সব কোড execute হয়
2. defer function গুলো stack বা "magic box"-এ store হয়
3. return value তখনই evaluate হয়; defer যদি variable পরিবর্তন করে, return value পরিবর্তিত হয় না
4. সব defer function execute হয়
   */
